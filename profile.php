                            ...
                            <form name="myform" onsubmit="return telValidate()" method="POST" action="">
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtfname" class="form-control input-field"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="txtlname" class="form-control input-field"
                                ...
                                <div class="row g-3">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="txtemail" class="form-control input-field"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="txttel" class="form-control input-field"
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 d-flex justify-content-center gap-3">
                                        <input type="submit" class="btn btn-primary submit px-4" name="btnupdate"
