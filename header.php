        ...
        <ul class="navbar-nav justify-content-center align-items-center fs-5 flex-grow-1 pe-3">
          ...
          <?php } else { ?>
            ...
            <div class="d-flex flex-column flex-lg-row justify-content-center align-items-center gap-3">
              ...
              <a href="register.php" class="text-white text-decoration-none px-3 py-1 rounded-4"
                style="background-color:red;">Register</a>
            </div>
          <?php } ?>
      ...
      <div class="offcanvas-body d-flex flex-column flex-lg-row p-4 p-lg-0 w-100 mt-1">
        <ul class="navbar-nav justify-content-center align-items-center fs-5 flex-grow-1 pe-3">
          ...
          <div class="d-flex align-items-center ms-auto">
            ...
            <?php } else { ?>
              <!-- Login / Sign Up -->
              <div class="d-flex align-items-baseline ms-auto gap-3">
                <a href="login.php" class="text-white">Login</a>
